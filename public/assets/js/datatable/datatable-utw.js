// public/assets/js/datatable/datatable-utw.js
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if (data.can_update) {
                        btn += `
                        <a href="/sdm-hukum/utw/${data.id}/edit"
                    ...
                    if (data.can_delete) {
                        btn += `
                                <form action="/sdm-hukum/utw/${data.id}" method="POST" style="display:inline;">
