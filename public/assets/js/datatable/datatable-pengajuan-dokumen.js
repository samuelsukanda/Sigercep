// public/assets/js/datatable/datatable-pengajuan-dokumen.js
$(document).ready(function () {
    $("#pengajuanDokumenTable").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            ...
            { data: "nomor_dokumen" },
            {
                ...
                render: function (data) {
                    const cls =
                        data === "Baru" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800";
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (type === "sort" || type === "type") {
                        return row.tanggal_pengajuan_timestamp;
                    }
                    return data;
                },
            },
            { data: "diajukan_oleh" },
            {
                ...
                render: function (data) {
                    ...
                    if (data.can_update) {
                        btn += `
                        <a href="/komite-mutu/pengajuan-dokumen/${data.id}/edit"
                    ...
                    if (data.can_read) {
                        btn += `
                            <a href="/komite-mutu/pengajuan-dokumen/${data.id}"
                    ...
                    if (data.can_delete) {
                        btn += `
                                <form action="/komite-mutu/pengajuan-dokumen/${data.id}" method="POST" style="display:inline;">
