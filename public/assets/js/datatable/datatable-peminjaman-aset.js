    ...
    columns: [
        ...
        { data: "tempat_asal_barang" },
        {
            ...
            render: function (data) {
                ...
                if (data.can_update) {
                    btn += `
                    <a href="/pengadaan-aset/peminjaman-aset/${data.id}/edit"
                ...
                if (data.can_read) {
                    btn += `
                        <a href="/pengadaan-aset/peminjaman-aset/${data.id}"
                ...
                if (data.can_delete) {
                    btn += `
                            <form action="/pengadaan-aset/peminjaman-aset/${data.id}" method="POST" style="display:inline;">
