...
class ChangeRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('change-request.index') . '?saved=1')->with('success', 'Change Request berhasil dikirim dan menunggu approval.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect(route('change-request.index') . '?updated=1')->with('success', 'Change Request berhasil diperbarui.');
    }
