...
@section('title', 'SIGERCEP - Edit Kesiapan Ambulance')
            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="mb-0 font-bold text-lg">Edit Kesiapan Ambulance</h6>
                    </div>
                    <div class="flex-auto p-6">
                        <form action="{{ route('kesiapan-ambulance.update', $ambulance->id) }}" method="POST"
                            ...
                            <div class="mt-6">
                                ...
                                <x-button.cancel type="button" class="ml-2 bg-gray-200"
                                    onclick="window.location='{{ route('kesiapan-ambulance.index') }}'">
                                    Batal
                                </x-button.cancel>
                            </div>
                        </form>
