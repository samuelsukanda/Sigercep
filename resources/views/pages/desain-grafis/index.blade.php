...
@section('title', 'SIGERCEP - Daftar Desain Grafis')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-palette" title="Daftar Desain Grafis" subtitle="Kelola permintaan desain grafis" />

                {{-- Filter Section --}}
                @include('layouts.partials.desain-grafis.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-desain-grafis.js') }}"></script>
