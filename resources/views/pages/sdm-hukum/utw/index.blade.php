...
@section('title', 'SIGERCEP - Daftar UTW')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-list-check" title="Daftar UTW" subtitle="Kelola data UTW" />

                {{-- Filter Section --}}
                @include('layouts.partials.sdm-hukum.utw.filter')

                {{-- DataTable --}}
                @include('layouts.partials.sdm-hukum.utw.datatable')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-utw.js') }}"></script>
