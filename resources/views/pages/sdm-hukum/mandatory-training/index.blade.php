...
@section('title', 'SIGERCEP - Daftar Mandatory Training')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-chalkboard-user" title="Daftar Mandatory Training" subtitle="Kelola mandatory training" />

                {{-- Filter Section --}}
                @include('layouts.partials.sdm-hukum.mandatory-training.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-mandatory-training.js') }}"></script>
