...
@section('title', 'SIGERCEP - Daftar Bank Ilmu')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-book" title="Daftar Bank Ilmu" subtitle="Kelola data bank ilmu" />

                {{-- Filter Section --}}
                @include('layouts.partials.bank-ilmu.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-bank-ilmu.js') }}"></script>
