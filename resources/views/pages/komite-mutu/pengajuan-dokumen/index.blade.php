...
@section('title', 'SIGERCEP - Daftar Pengajuan Dokumen')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-file-import" title="Daftar Pengajuan Dokumen" subtitle="Kelola pengajuan dokumen" />

                {{-- Filter Section --}}
                @include('layouts.partials.komite-mutu.pengajuan-dokumen.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-pengajuan-dokumen.js') }}"></script>
