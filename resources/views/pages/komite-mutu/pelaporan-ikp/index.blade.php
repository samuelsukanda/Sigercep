...
@section('title', 'SIGERCEP - Daftar Pelaporan IKP')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-circle-exclamation" title="Daftar Pelaporan IKP" subtitle="Kelola pelaporan IKP" />

                {{-- Filter Section --}}
                @include('layouts.partials.komite-mutu.pelaporan-ikp.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-pelaporan-ikp.js') }}"></script>
