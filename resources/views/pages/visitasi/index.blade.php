...
@section('title', 'SIGERCEP - Daftar Visitasi')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-clipboard-list" title="Daftar Visitasi" subtitle="Kelola data visitasi" />

                {{-- Filter Section --}}
                @include('layouts.partials.visitasi.filter')

                {{-- DataTable --}}
                @include('layouts.partials.visitasi.datatable')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-visitasi.js') }}"></script>
