...
@section('title', 'SIGERCEP - Daftar Komite Medik')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-laptop-medical" title="Daftar Komite Medik" subtitle="Kelola data komite medik" />

                {{-- Filter Section --}}
                @include('layouts.partials.komite-medik.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-komite-medik.js') }}"></script>
