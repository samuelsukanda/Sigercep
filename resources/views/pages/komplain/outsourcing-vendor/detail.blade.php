...
@section('title', 'SIGERCEP - Detail Komplain Outsourcing Vendor')
            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div class="relative flex flex-col bg-white shadow-soft-xl rounded-2xl">
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="mb-0 font-bold text-lg">Detail Komplain Outsourcing Vendor</h6>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-600">
                                    {{ \Carbon\Carbon::createFromFormat('H:i:s', $komplain->jam)->format('H:i') }}
                            </div>
                            ...
                            {{-- Area --}}
                            <div>
                                <label class="block mb-1 text-sm font-semibold text-slate-700">Area Komplain Yang
                                    Di Laporkan</label>
