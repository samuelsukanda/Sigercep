...
@section('title', 'SIGERCEP - Daftar Komplain Outsourcing Vendor')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-handshake" title="Daftar Komplain Outsourcing Vendor" subtitle="Kelola komplain outsourcing vendor" />

                {{-- Filter Section --}}
                @include('layouts.partials.komplain.outsourcing-vendor.filter')

                {{-- DataTable --}}
                @include('layouts.partials.komplain.outsourcing-vendor.datatable')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-outsourcing-vendor.js') }}"></script>
