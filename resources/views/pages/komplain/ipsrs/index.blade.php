...
@section('title', 'SIGERCEP - Daftar Komplain IPSRS')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-tools" title="Daftar Komplain IPSRS" subtitle="Kelola komplain IPSRS" />

                {{-- Filter Section --}}
                @include('layouts.partials.komplain.ipsrs.filter')

                {{-- DataTable --}}
                @include('layouts.partials.komplain.ipsrs.datatable')
