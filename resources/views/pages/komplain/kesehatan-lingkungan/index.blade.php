...
@section('title', 'SIGERCEP - Daftar Komplain Kesehatan Lingkungan')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-leaf" title="Daftar Komplain Kesehatan Lingkungan" subtitle="Kelola komplain kesehatan lingkungan" />

                {{-- Filter Section --}}
                @include('layouts.partials.komplain.kesehatan-lingkungan.filter')

                {{-- DataTable --}}
                @include('layouts.partials.komplain.kesehatan-lingkungan.datatable')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-kesehatan-lingkungan.js') }}"></script>
