...
@section('title', 'SIGERCEP - Daftar Peminjaman Aset')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-boxes-stacked" title="Daftar Peminjaman Aset" subtitle="Kelola peminjaman aset" />

                {{-- Filter Section --}}
                @include('layouts.partials.pengadaan-aset.peminjaman-aset.filter')

                {{-- DataTable --}}
                @include('layouts.partials.pengadaan-aset.peminjaman-aset.datatable')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-peminjaman-aset.js') }}"></script>
