...
@section('title', 'SIGERCEP - Edit Pengembalian Aset')
            ...
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="mb-0 font-bold text-lg">Edit Pengembalian Aset</h6>
                    </div>
                    <div class="flex-auto p-6">
                        <form action="{{ route('pengadaan-aset.pengembalian-aset.update', $pengadaan->id) }}" method="POST"
                            ...
                            <div class="mt-6">
                                ...
                                <x-button.cancel type="button" class="ml-2 bg-gray-200"
                                    onclick="window.location='{{ route('pengadaan-aset.pengembalian-aset.index') }}'">
                                    Batal
                                </x-button.cancel>
                            </div>
                        </form>
