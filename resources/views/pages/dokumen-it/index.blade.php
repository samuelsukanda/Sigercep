...
@section('title', 'SIGERCEP - Daftar Dokumen IT')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-file-alt" title="Daftar Dokumen IT" subtitle="Kelola dokumen IT" />

                {{-- Filter Section --}}
                @include('layouts.partials.dokumen-it.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-dokumen-it.js') }}"></script>
