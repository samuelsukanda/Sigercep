...
@section('title', 'SIGERCEP - Daftar Toner')
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 mx-auto mt-0">
                {{-- Header --}}
                <x-page-header icon="fa-cart-flatbed" title="Daftar Toner" subtitle="Kelola data toner" />

                {{-- Filter Section --}}
                @include('layouts.partials.toner.filter')
...
@push('scripts')
    <script src="{{ asset('assets/js/datatable/datatable-toner.js') }}"></script>
