<!-- sidebar  -->
<aside
    class="fixed inset-y-0 flex flex-col w-full p-0 my-4 overflow-hidden antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0"
    aria-expanded="false">
    <div class="h-19">
    ...
    <div id="sidebar-scroll" class="items-center block w-auto grow basis-full"
        style="flex:1 1 auto; min-height:0; overflow-y:auto; overflow-x:hidden; padding-bottom:16px;">
        ...
        <ul class="flex flex-col pl-0 mb-0">
                    ...
                    @canAccess('helpdesk', 'manage')
                        <li class="w-full">
                            <a href="{{ route('admin.helpdesk.index') }}"
                                ...
                                <span class="ml-1">Admin Helpdesk</span>
                            </a>
                        </li>
            ...
            <li class="mt-0.5 w-full">
                ...
                <ul class="max-h-0 overflow-hidden flex-col pl-10 mt-1 space-y-1 transition-all duration-300 ease-in-out"
                    ...
                    <li class="w-full">
                        <a href="{{ route('hardware.evaluasi') }}"
                            class="py-2.7 text-sm ease-nav-brand mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-normal text-slate-600 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80">
                            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center">
                                <i class="fas fa-list text-sm leading-normal"></i>
                            </div>
                            <span class="ml-1">Evaluasi</span>
                        </a>
                    </li>
                    <li class="w-full">
                        <a href="{{ route('hardware.health-check.index') }}"
                            class="py-2.7 text-sm ease-nav-brand mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-normal text-slate-600 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80">
                            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center">
                                <i class="fas fa-list text-sm leading-normal"></i>
                            </div>
                            <span class="ml-1">Health Check</span>
                        </a>
                    </li>
                    <li class="w-full">
                        <a href="{{ route('hardware.credential.index') }}"
                            class="py-2.7 text-sm ease-nav-brand mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-normal text-slate-600 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80">
                            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center">
                                <i class="fas fa-list text-sm leading-normal"></i>
                            </div>
                            <span class="ml-1">Credential</span>
                        </a>
                    </li>
                </ul>
            </li>
