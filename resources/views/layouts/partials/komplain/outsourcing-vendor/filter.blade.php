<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-4">
    <div class="px-5 py-4">
        <form method="GET" action="{{ route('komplain.outsourcing-vendor.index') }}" id="filterForm">
            <div class="flex flex-wrap gap-3 items-end filter-wrap">
                ...
                <div class="flex items-end flex-1 justify-between filter-action">
                    ...
                    {{-- Tambah Data --}}
                    @canAccess('outsourcing_vendor', 'create')
                    <a href="{{ route('komplain.outsourcing-vendor.create') }}"
