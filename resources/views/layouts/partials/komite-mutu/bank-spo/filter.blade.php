<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-4">
    <div class="px-5 py-4">
        <form method="GET" action="{{ route('komite-mutu.bank-spo.index') }}" id="filterForm">
            <div class="flex flex-wrap gap-3 items-end filter-wrap">
                ...
                <div class="flex flex-col mr-1 filter-item" style="min-width:148px; flex:1 1 148px; max-width:200px;">
                ...
                {{-- Jenis SPO --}}
                <div class="flex flex-col mr-1 filter-item" style="min-width:148px; flex:1 1 148px; max-width:175px;">
                    ...
                    <select id="jenis_spo" name="jenis_spo"
                        ...
                        <option value="SPO Terkait" {{ request('jenis_spo') == 'SPO Terkait' ? 'selected' : '' }}>SPO
                            Terkait</option>
                    </select>
                </div>
                ...
                <div class="flex items-end flex-1 justify-between filter-action">
                    ...
                    <a href="{{ route('komite-mutu.bank-spo.create') }}"
